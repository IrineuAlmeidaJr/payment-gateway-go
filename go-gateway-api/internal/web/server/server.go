...
import (
	...
	"github.com/irineualmeidajr/imersao22/go-gateway/internal/web/handlers"
	"github.com/irineualmeidajr/imersao22/go-gateway/internal/web/middleware"
)
...
func (s *Server) ConfigureRoutes() {
	...
	// Criando um groupo de rotas protegidas
